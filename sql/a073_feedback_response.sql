...
CREATE TABLE `feedback_response` (
  ...
  KEY `fk_feedback_response_complaint1_idx` (`complaint_complaint_id`),
  CONSTRAINT `fk_feedback_response_complaint1` FOREIGN KEY (`complaint_complaint_id`) REFERENCES `complaint` (`complaint_id`)
...
INSERT INTO `feedback_response` VALUES (5000,4001,'Is your problem solved?',NULL);
