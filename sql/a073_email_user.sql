...
CREATE TABLE `email_user` (
  ...
  KEY `fk_email_user_admin1_idx` (`admin_id`),
  KEY `fk_email_user_user1_idx` (`user_id`),
  CONSTRAINT `fk_email_user_admin1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`admin_id`),
  CONSTRAINT `fk_email_user_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
