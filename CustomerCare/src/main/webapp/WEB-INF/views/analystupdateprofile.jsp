...
<form:form modelAttribute="analyst" action="/analystupdate/${analystId}" method="post" cssClass="text-left border border-light p-5" >
				...
				<div class="form-row mb-2">
					...
					<div class="col">
						<form:input path="firstName" value="${analyst.firstName}" />
					</div>
				</div>
				...
				<div class="form-row mb-2">
					...
					<div class="col">
						<form:input path="lastName" value="${analyst.lastName}" />
					</div>
				</div>
